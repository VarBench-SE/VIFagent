%Cartoon monkey face in circle
\documentclass[tikz,border=5]{standalone}
\usepackage[prefix=]{xcolor-material}

\tikzset{
half clip/.code={
%Dark brown outline around monkey face, Pink monkey face
...
%Dark brown monkey ear, Dark brown monkey ear
\fill [skin] (140, 80) circle  [radius=56];
%Dark brown monkey ear, Dark brown monkey ear
\fill [ears] (140, 80) circle  [radius=32];
%Dark brown monkey head outline, Dark brown monkey ear
...
%Pink inner monkey ear, Pink inner monkey ear
\fill [face] (40,64) ellipse [radius=64];
}
\reflect{
%Black monkey eye, Black monkey eye
\fill [BlueGrey900] (40, 64) circle [radius=24];
%Two pink monkey nostrils, Dark brown outline around monkey face
\fill [Pink300]     (24,-16) circle [radius=16];
}
%Pink smiling monkey mouth, Dark brown outline around monkey face
\fill [Pink300]
